...
const ProductList = (props) => {
    ...
    let list = [{ name: 'camera', price: 100 }, { name: 'bag', price: 50 }]
                    ...
                    return (
                        <div id={id} className='category__list-product' key={i}>
                            ...
                            <div className='category__list-nameprice-container'>
                                <div className='category__list-product-name'>{product.name}</div>
                                <div className='category__list-product-price'>${product.price}</div>
                            </div>
                        </div>
